...
nZeros <- c(8293947, 8886003, 14299638, 182096459, 12102140, 130297465, 13694912, 105926826, 8293950, 8293978, 6595428, 155163611, 37014133, 9394845, 12728318)
nTotal <- c(8429815, 9030225, 14494238, 184339585, 12255889, 132487080, 13870655, 106275895, 8429818, 8429845, 8704551, 192392071, 37512992, 9543463, 12878454)
...
zerosPlot <- zerosPlot + theme(axis.text.x = element_text(angle = 90, hjust = 1), legend.position = "top", text = element_text(size=16))
...
png(filename = "R/results/nZeros.png", width = 800, height = 600)
plot(zerosPlot)
dev.off()
