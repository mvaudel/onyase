...
public class OnyaseEngineCLI implements Callable {
    ...
    private static String getHeader() {
        return System.getProperty("line.separator")
                ...
                + "This program is licensed under the terms of the GNU General Public License. See https://github.com/mvaudel/onyase/blob/master/LICENSE for details." + System.getProperty("line.separator")
                + System.getProperty("line.separator")
                + "Spectra must be provided in the Mascot Generic File (mgf) format." + System.getProperty("line.separator")
                + System.getProperty("line.separator")
                + "The identification parameters can be provided as a file as saved from the GUI of SearchGUI and PeptideShaker, or generated using the IdentificationParametersCLI." + System.getProperty("line.separator")
